...
ActiveRecord::Schema.define(version: 2021_07_05_135311) do
  ...
  create_table "schedule_exercises", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_schedule_exercises_on_user_id"
  end
  ...
  add_foreign_key "schedule_exercises", "users"
end
